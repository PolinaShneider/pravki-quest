<style scoped>
    .start-screen {
        ...
        &__download {
            ...
            background: linear-gradient(to bottom, rgba(255,255,255,255.75) 0%,rgba(255,255,255,0) 100%);
            ...
            &:hover {
                color: #fff;
                background: linear-gradient(to bottom, rgba(121,82,179,1) 0%,rgba(95,49,125,1) 100%);
            }
        }
...
<template>
    <div class="start-screen__container">
        ...
        <a class="start-screen__download" v-bind:class="{hide : !downloadButtonIsVisible}" href="/pravki-quest/pravki.zip" download>Скачать</a>
    </div>
</template>
<script>
    export default {
        props: ['downloadButtonIsVisible'],
        data: function() {
            return {
                isHigh: false,
            };
        ...
        methods: {
            ...
            raiseUp: function () {
                ...
                this.isHigh = true;
                this.$parent.$emit('raiseUp', this.isHigh);
